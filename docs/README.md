...
| [Architecture deepening plan](2026-08-07-architecture-deepening-plan.md) | Reviewing the 5 completed deepening candidates from the 2026-08-07 architecture review | Completed deepening plan with implementation order | Each candidate's acceptance criteria under `npm test` |
| [Trailing comment provenance fix](2026-08-18-trailing-comment-provenance.md) | Reviewing the Issue #44 hover documentation provenance validation (local declaration source-first, trailing-comment rejection) | Completed 2026-08-18 fix with regression cases | `npm test` plus resolver and source-comment adapter tests |
| [Project review optimization plan](2026-08-07-project-review-optimization-plan.md) | Planning the 2026-08-07 full-project review findings (performance, robustness, competitive features) | Current review plan with batched implementation order | Each batch's acceptance criteria under `npm test` |
| [Documentation model + adaptive summary](2026-08-18-provenance-adaptive-summary.md) | Reviewing the documentation data model (fullText + source + range) and the adaptive summary presentation policy | Completed summary/data-model redesign on top of the provenance fix | `npm test` plus hintSummary and Go scenario regression tests |
