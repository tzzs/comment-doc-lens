...
| [Architecture deepening plan](2026-08-07-architecture-deepening-plan.md) | Planning the 5 deepening candidates from the 2026-08-07 architecture review | Current deepening plan with implementation order | Each candidate's acceptance criteria under `npm test` |
