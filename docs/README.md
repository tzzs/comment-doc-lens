...
| [Documentation provenance + adaptive summary](2026-08-18-provenance-adaptive-summary.md) | Reviewing the Issue #44 trailing-comment fix and the adaptive summary architecture | Completed provenance and summary redesign | `npm test` plus Go scenario regression tests |
